odoo.define('web_search_with_and/static/src/js/control_panel_model_extension.js', function(require) {
    ...
    patch(components.ControlPanelModelExtension, 'web_search_with_and/static/src/js/control_panel_model_extension.js', {

        addAutoCompletionValues({ filterId, label, value, operator, isShiftKey}) {
