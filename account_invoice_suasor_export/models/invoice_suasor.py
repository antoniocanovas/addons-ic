...
class SuasorInvoice(models.Model):
    ...
    n_documento = fields.Char('NÚMERO DOCUMENTO')
    ...
    cta_contrapartida1 = fields.Char('CTA. CONTRAPARTIDA')
    base_iva2 = fields.Char('BASE IVA 2')
    ...
    cta_contrapartida2 = fields.Char('CTA. CONTRAPARTIDA 2')
    base_iva3 = fields.Char('BASE IVA 3')
    ...
    cta_contrapartida3 = fields.Char('CTA. CONTRAPARTIDA 3')
