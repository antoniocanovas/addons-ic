...
class RealstateProperty(models.Model):
     ...
     origin = fields.Selection(selection=[('new','NEW'),('2hand','SECOND HAND')],string="Origin",default='new')
     ...
     orientation = fields.Selection(selection=[('sur','SUR'),('sureste','SURESTE'),('este','ESTE'),('noreste','NORESTE'),('norte','NORTE'),('noroeste','NOROESTE'),('oeste','OESTE'),('suroeste','SUROESTE')],string="State",default='este')
